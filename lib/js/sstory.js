...
sStory = (function() {
  ...
  sStory.prototype.render = function() {
    var codeGist, codeTributary, locationSinglePlace, photoBigText, photoCaption, photoMulti, sections, soundSoundcloud, targetContainer, targetID, that, timelineVerite, videoVimeo, videoYoutube;
  ...
  sStory.prototype.makeNavSectionList = function() {
    ...
    $('#header-front h1').click(function() {
    ...
    return $(window).on('scroll', function() {
      var bodyHeight, position, scrollTop;
