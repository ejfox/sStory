...
var correctInputs, getJsonCode, makeBuilder, makeTimeline, sStory, submitNewSection;
...
getJsonCode = function() {
  return $('#json-code').val(sections.join("")).show();
};

submitNewSection = function() {
  var sectionCaption, sectionEmbed, sectionTitle, sectionType, sectionUrl;
  ...
  if (sectionType === "image" || sectionType === "image2" || sectionType === "image3") {
    sections.push({
      title: sectionTitle,
      type: sectionType,
      url: sectionUrl,
  ...
  } else if (sectionType === "soundcloud") {
    sections.push({
      title: sectionTitle,
      type: sectionType,
      embed: sectionEmbed
