...
sStory = (function() {
  ...
  sStory.prototype.render = function() {
    var codeGist, codeTributary, locationSinglePlace, locationTimeline, photoBigText, photoCaption, photoMulti, sections, soundSoundcloud, targetContainer, targetID, text, that, timelineVerite, videoVimeo, videoYoutube;
  ...
  sStory.prototype.makeNavSectionList = function() {
    ...
    _.each(this.story_list, function(section, i) {
      ...
      $listItem = $("<li class='" + listClass + "' id='" + i + "'></li>").append('<div class="outerContainer"> </div>').append('<div class="innerContainer"> </div>').append('<div class="element"> </div>').html($link);
